...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"><%--Admin task--%>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                            <img id="imgview" width="100px" src="book_inventory/bookinventory.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <br />
                        <div class="d-grid gap-4 d-md-block">
                           <asp:Button class="btn btn-success" runat="server" Text="ADD" OnClick="Button1_Click"/>
                            <asp:Button class="btn btn-primary" runat="server" Text="Update" OnClick="Button2_Click" />
                            <asp:Button class="btn btn-danger" runat="server" Text="Delete" OnClick="Button3_Click" />
                        </div>
               </div>
            </div>
