            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="images/issuebook1.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="d-grid gap-2 d-md-block">
                            <asp:Button class="btn btn-outline-info" runat="server" Text="Issue" OnClick="Button2_Click"/>
                            <asp:Button class="btn btn-outline-success" runat="server" Text="Return" OnClick="Button3_Click" />
                        </div>
                    </div>
                </div>
